...
class inflow_outflow():
    ...
    def create_inflow_outflow(self):     
        for file in self.files:
            ...
            trajectory = self.process_long_lati_one_trajectory(trajectory, inflow_outflow_raw_data_pathname)
...
h5_file_name = "./info/TaxiDD_" + str(begin_long) + "_" + str(end_long) + "_" + str(begin_lati) + "_" + str(end_lati) + "_" + str(time_interval) + "_" + str(m) + "_" + str(n) + "_" + str(nb_flows) + "_count.h5"
...
parent_dir = "/home/linc/two_storage/data/rome_data/"
...
with open("./info/" + str(time_interval) + "_" + str(begin_long) + "_" + str(end_long) + "_" + str(begin_lati) + "_" + str(end_lati) + "_" + str(m) + "_" + str(n) + ".files","w") as f:
...
for f in flow.files:
    ...
    #print(f)
    trajectory = two.get_trajectory(f)
